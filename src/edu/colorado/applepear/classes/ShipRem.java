...
public class ShipRem {
    ...
    public void setShipName() {
        ...
        if (location.size() < 1) {
            ...
            if ( (location.get(0).getY()) == ((location.get(1).getY())) && (location.get(0).getY()) ==  (location.get(2).getY())){
                shipName = "destroyer";
            }
            else if ( (location.get(0).getX()) == ((location.get(1).getX())) && (location.get(0).getX()) ==  (location.get(2).getX())){
                shipName = "destroyer";
            }
