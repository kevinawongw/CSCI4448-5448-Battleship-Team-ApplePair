...
public class GameBoard {
    ...
    public int[][] getUnderwaterMap() {
        return underwaterMap;
    }

    public int[][] getUnderwaterAttackMap() {
        return underwaterAttackMap;
    }
     ...
     */
    public void setShipMap(Point point, int newValue) {
        shipMap[point.getY()][point.getX()] = newValue;
    }

    public void setAttackMap(Point point, int newValue) {
        attackMap[point.getY()][point.getX()] = newValue;
    }

    public void setUnderwaterMap(Point point, int newValue) {
        underwaterMap[point.getY()][point.getX()] = newValue;
    }

    public void setUnderwaterAttackMap(Point point, int newValue) {
        underwaterAttackMap[point.getY()][point.getX()] = newValue;
    }
...
//        viewUnderwater();
     ...
     * Place Ship
     *
     * @param loc // Determine what type of ship it is
     ...
     * Update Sunken Ship
     *
     * @param shipAttackedIndex // Removes ship from ships array when a ship is sunken.
     */
